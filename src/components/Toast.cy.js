...
var REQUIRED_PROPS = __assign(__assign({}, defaultProps), {
  isIn: true,
  autoClose: false,
  closeToast: function () {},
  type: 'default',
...
describe('Toast', function () {
  var _loop_1 = function (name_1, className, bodyClassName) {
    it(
      'merge container and body className when using '.concat(name_1),
      function () {
        cy.mount(
          React.createElement(
            Toast,
            __assign({}, REQUIRED_PROPS, {
              className: className,
  ...
  it('support rtl', function () {
    cy.mount(
      React.createElement(
        Toast,
        __assign({}, REQUIRED_PROPS, { rtl: true }),
        'FooBar'
      )
    );
  ...
  describe('autoClose', function () {
    it('does not render progress bar when false', function () {
      cy.mount(
        React.createElement(
          Toast,
          __assign({}, REQUIRED_PROPS, { autoClose: false }),
          'FooBar'
        )
      );
    ...
    it('resume and pause progress bar', function () {
      cy.mount(
        React.createElement(
          Toast,
          __assign({}, REQUIRED_PROPS, { autoClose: 5000 }),
          'hello'
        )
      );
  ...
  it('does not render close button when closeButton is false', function () {
    cy.mount(
      React.createElement(
        Toast,
        __assign({}, REQUIRED_PROPS, { closeButton: false }),
        'FooBar'
      )
    );
  ...
  it('does not pause progress bar when pauseOnHover is disabled', function () {
    cy.mount(
      React.createElement(
        Toast,
        __assign({}, REQUIRED_PROPS, { autoClose: 5000, pauseOnHover: false }),
        'hello'
      )
    );
    cy.resolveEntranceAnimation();
  ...
  describe('controller progress bar', function () {
    it('set the correct progress value bar disregarding autoClose value', function () {
      cy.mount(
        React.createElement(
          Toast,
          __assign({}, REQUIRED_PROPS, { progress: 0.3, autoClose: false }),
          'hello'
        )
      );
      cy.resolveEntranceAnimation();
      ...
      cy.mount(
        React.createElement(
          Toast,
          __assign({}, REQUIRED_PROPS, { progress: 0.3, autoClose: 5000 }),
          'hello'
        )
      );
      cy.resolveEntranceAnimation();
  ...
  it('override default closeButton', function () {
    cy.mount(
      React.createElement(
        Toast,
        __assign({}, REQUIRED_PROPS, {
          closeButton: React.createElement('span', null, '\uD83D\uDCA9')
        }),
        'hello'
      )
    );
  ...
  it('fallback to default closeButton', function () {
    cy.mount(
      React.createElement(
        Toast,
        __assign({}, REQUIRED_PROPS, { closeButton: true }),
        'hello'
      )
    );
    cy.resolveEntranceAnimation();
  ...
  describe('Drag event', function () {
    ...
    var _loop_4 = function (axis, delta) {
      it(
        'does not close toast when dragging on '.concat(axis, '-axis'),
        function () {
          cy.mount(
            React.createElement(
              'div',
