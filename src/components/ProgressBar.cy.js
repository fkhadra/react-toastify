  ...
  it('merge className', function () {
    cy.mount(
      React.createElement(
        ...
        React.createElement(
          ProgressBar,
          __assign({}, getProps(), { className: 'test' })
        )
      )
    );
  ...
  it('trigger closeToast when animation end', function () {
    ...
    cy.mount(
      React.createElement(
        ...
        React.createElement(
          ProgressBar,
          __assign({}, getProps(), { closeToast: closeToast, delay: delay })
        )
      )
    );
  ...
  it('pause the progress bar', function () {
    cy.mount(
      React.createElement(
        ...
        React.createElement(
          ProgressBar,
          __assign({}, getProps(), { isRunning: false })
        )
      )
    );
  ...
  it('control progress bar', function () {
    cy.mount(
      React.createElement(
        ...
        React.createElement(
          ProgressBar,
          __assign({}, getProps(), { controlledProgress: true, progress: 0.7 })
        )
      )
    );
    cy.findByRole('progressbar')
