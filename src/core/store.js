...
var dispatchChanges = function (data) {
  return listeners.forEach(function (cb) {
    return cb(data);
  });
};
var hasContainers = function () {
  return containers.size > 0;
};
function flushRenderQueue() {
  renderQueue.forEach(function (v) {
    return pushToast(v.content, v.options);
  });
  renderQueue = [];
}
export var getToast = function (id, _a) {
  ...
  return (_b = containers.get(containerId || 1 /* Default.CONTAINER_ID */)) ===
    null || _b === void 0
    ? void 0
    : _b.toasts.get(id);
};
export function isToastActive(id, containerId) {
  var _a;
  if (containerId)
    return !!((_a = containers.get(containerId)) === null || _a === void 0
      ? void 0
      : _a.isToastActive(id));
  var isActive = false;
...
export function removeToast(params) {
  if (!hasContainers()) {
    renderQueue = renderQueue.filter(function (v) {
      return params != null && v.options.toastId !== params;
    });
    return;
  }
...
export function registerToggle(opts) {
  var _a;
  (_a = containers.get(opts.containerId || 1 /* Default.CONTAINER_ID */)) ===
    null || _a === void 0
    ? void 0
    : _a.setToggle(opts.id, opts.fn);
}
export function toggleToast(v, opt) {
  containers.forEach(function (c) {
    if (
      opt == null ||
      !(opt === null || opt === void 0 ? void 0 : opt.containerId)
    ) {
      c.toggle(v, opt === null || opt === void 0 ? void 0 : opt.id);
    } else if (
      (opt === null || opt === void 0 ? void 0 : opt.containerId) === c.id
    ) {
      c.toggle(v, opt === null || opt === void 0 ? void 0 : opt.id);
    }
  });
...
export function registerContainer(props) {
  ...
  return {
    ...
    setProps: function (p) {
      var _a;
      (_a = containers.get(id)) === null || _a === void 0
        ? void 0
        : _a.setProps(p);
    },
    getSnapshot: function () {
      var _a;
      return (_a = containers.get(id)) === null || _a === void 0
        ? void 0
        : _a.getSnapshot();
    }
  };
